    ...
    <div class="d-flex w-100">
        ...
        <button type="button" class="btn btn-primary ml-auto pt-2 pb-1 my-auto mr-4 mr-md-3" data-toggle="modal" data-target="#createActivityModal">
            <i class="fas fa-plus"></i> <span class="d-none d-md-inline-block">Create New Activity</span>
        </button>
    </div>
        ...
        <div class="container my-auto p-3 position-relative">
            <div class="suroi-cards-4">
                <div class="position-relative d-flex flex-column">
                    <div id="suroi-admin-activities" class="carousel slide" data-ride="carousel" data-interval="false">
                                ...
                                <div class="row">
                                    @while (true)
                                        <div class="col-md-6 col-lg-3">
                                            <div class="card">
                                                <div class="image-holder d-flex flex-column" style="background-image: url(@if($activities[$j]->photo == NULL)'http://lorempixel.com/400/400/'@else '{{ $activities[$j]->photo }}'@endif);">
                                                    <span class="align-bottom position-relative">{{ ucwords($activities[$j]->name) }}</span>
                        ...
                        @for ($i = 0; $i < (count($activities)/4); $i++)
                            <i data-target="#suroi-admin-activities" data-slide-to="{{ $i }}" class="fas fa-circle @if ($i == 0) active @endif"></i>
                        @endfor
                        </div>
                    </div>

                    @if  (count($activities) > 4)
                        <div class="d-none d-lg-flex next-arrow my-auto" href="#suroi-admin-activities" role="button" data-slide="next">
    ...
    <div class="modal fade pt-5 mt-5" id="createActivityModal" tabindex="-1" role="dialog" aria-labelledby="createActivityModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('tags.store') }}" style="width: 100%!important;" enctype="multipart/form-data" >
                    ...
                    <div class="modal-body">
                        ...
                        <input id="type" name="type" type="hidden" value="activity">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select id="parent" name="parent" class="form-control{{ $errors->has('parent') ? ' is-invalid' : '' }}" required>
                                    ...
                                    <option value="{{ $activity->id }}"> {{ ucwords($activity->name) }}</option>
                                    @endforeach
                                </select>
