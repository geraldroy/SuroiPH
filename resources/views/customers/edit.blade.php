            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="transaction-surname" value="{{ $customer->name_last }}">
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="transaction-firstname" value="{{ $customer->name_first }}">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="transaction-midname"><strong>Middle Name </strong></label>
                  <input type="text" class="form-control" id="transaction-midname" value="{{ $customer->name_middle }}">
                </div>
              </div>
            </div>
            <div class="row">
